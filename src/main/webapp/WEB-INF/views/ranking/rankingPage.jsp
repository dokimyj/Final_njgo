...
<section class="main_section">
	<div class="main_wrap">
		<table width="778" height="470" border="0" cellpadding="0" cellspacing="0">
				<tbody>
					<tr>
						...
						<table width="778" border="0" cellspacing="0" cellpadding="0">
							<tbody>
								<tr>
									<td style="border-top: 1px solid #dbdbdb" height="45"><span class="rank_tt1">${board}</span><span class="rank_tt2">월간 ${board} 순위를 나타냅니다.</span></td>
								</tr>
							</tbody>
						</table>
							<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 15px">
								<tbody>
									...
									<tr>
										<td align="center">
													<table width="540" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 10px; margin-top: 20px">
														<tbody>
															<tr>
															...
															<tr>
																			...
																			<tr>
																				...
																				<td align="left"><span class="rank_pic" style="height: 111px; border-radius: 100px;">
																					<span style="cursor: hand;"> 
																						<img src="https://bigoven-res.cloudinary.com/image/upload/t_recipe-256/easy-chicken-teriyaki-4.jpg"
																							border="0" width="107" height="86" style="height: 111px; border-radius: 100px;">
																					</span>
																				</span></td>
																			</tr>
																			<tr>
																				<td height="25" align="left" class="rank_id"><span style="cursor: hand"></span></td>
																			</tr>
																			<tr>
																...
																<th width="40" valign="top">
																	<img src="http://img.tygem.com/images/06/ranking/icon_rank2_1.gif"></th>
																		<td width="140" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
																		<tbody>
																			<tr>
																				<!-- 사진2 -->
																			...
																			<tr>
																				<td height="25" align="left" class="rank_r"><img src="http://img.tygem.com/images/06/ranking/icon_rank2_2.gif"
																					align="absmiddle" style="margin-right: 6px">1,320</td>
																			</tr>
																		</tbody>
																	</table></td>
																<th width="40" valign="top">
																<img src="http://img.tygem.com/images/06/ranking/icon_rank3_1.gif"></th>
																<td width="140" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
																		<tbody>
																			<tr>
																				<!-- 사진3 -->
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tbody>
										<tr>
											...
											</select><input type="text" id="fullname" value="" class="rank_in">
											<img src="http://img.tygem.com/images/06/ranking/btn_search.gif" align="absmiddle" onclick="javascript:search_list(0,'2017-07','all')"
												style="cursor: pointer;"></td>
											<td width="51%" align="right" valign="bottom"><span class="rank_tt2">* 최종 업데이트: 2017-07-19 02:10</span></td>
										</tr>

									</tbody>
								</table>
								<br>
								<c:if test="${column == 'hit'}">
										<table class="t_type1" width="778">
											...
											<c:forEach var="list" items="${list}" begin="1" end="3">
												<tr>
													<td width="90">1</td>
													<td colspan="2" width="170"><span onclick="#" style="cursor: pointer">${list.foodname}</span></td>
